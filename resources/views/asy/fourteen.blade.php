...
@section('content')
    <!--第四页-->
    <div class="page page4  gremAll newpage">
        <div class="day pos">
            <img src="{{ asset('asy/eyeImg/xiugai/14.png') }}"/>
        </div>
        ...
        <div class="shake pos">
            ...
            <div class="shakeImg">
                <img src="{{asset('asy/eyeImg/shake.pn')}}g"/>
            </div>
        ...
        if ((curTime - last_update) > 100) {
            ...
            if (speed > SHAKE_THRESHOLD) {
                ...
                if (num > 15) {
                    ...
                    $('.page4 .goBtm').fadeIn(2000);

                    $('.page4 .trowBtm').fadeIn(2000);
