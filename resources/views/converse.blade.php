    ...
    <div class="container">
        ...
        <div class="page page3Container">
            <div class="personInfo pos ">
                <p>
                    我是 <input class="text1 text" class="text2" type="text" name="">,
            ...
            <div class="popup ">
                <label class="modal modal1">
                    ...
                    <input type="file" id="gocamera" capture="camera" style="display: none">
                </label>
            </div>
...
<div class="page page3 page33 hidden" id="pa">
    <div class="bg">
        <img src="{{asset('converse/img/photoword/shoneBody.png')}}"/>
    </div>
    <div class="pic" id="view"></div>
